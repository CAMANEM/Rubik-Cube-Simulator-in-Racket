...
(define (generateChangedRow_R X originalCube i j new_i face new_face i_inverted)
  (cond ((equal? X j) (append '()))
        ...
        ((and (equal? new_face 3) (equal? i new_i))(append (list (getValue originalCube new_face new_i (- X j 1))) (generateChangedRow_R X originalCube i (+ 1 j) new_i face new_face i_inverted) ))
